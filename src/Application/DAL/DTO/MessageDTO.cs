    ...
    public class MessageDTO : EntityDTO, IMapFrom<Message>
    {
        ...
        public void Mapping(Profile profile)
        {
            profile.CreateMap<MessageTransmission, MessageDTO>()
                ...
                .ForMember(dest => dest.Sender, opt => opt.MapFrom(src => src.Message.Sender.Username))
                ...
                .ForMember(dest => dest.RecipientsString, opt => opt.MapFrom(src => string.Join(", ", src.Message.Recipients.Select(x => x.Recipient.Username).ToArray())))
